...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='mayan',db='cv')
...
def run():
    ...
    activities = ["User", "Feedback", "About","BOT", "Admin"]
    choice = st.sidebar.selectbox("Choose among the given options:", activities)
    link = '<b>Built by <a href="https://www.linkedin.com/in/mayan-suthar-5625b1229/" style="text-decoration: none; color: #021659;">Mayan Suthar </a></b>' 
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
          if pdf_file.type != 'application/pdf':
            st.experimental_rerun()  # Trigger rerun to display pop-up alert
            st.write('<script>alert("Please upload a PDF file.");</script>', unsafe_allow_html=True)
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="https://www.linkedin.com/in/mayan-suthar-5625b1229/" style="text-decoration: none; color: grey;">Mayan Suthar</a> and 
            <a href="#" style="text-decoration: none; color: grey;">Mahendra Dod</a> and
            <a href="https://www.linkedin.com/in/nawaz-bakali-87754a1b9/" style="text-decoration: none; color: grey;">Nawaz Bakali</a>
        </p>

        ''',unsafe_allow_html=True)  
    elif choice == 'BOT':
        st.success('Welcome to the Ai Bot')
        st.subheader("Ask me anything about the project or your resume data:")
        st.markdown('''

        <p align='justify'>
        Welcome! This page provides information about my project and allows you to interact with an AI chatbot that can answer questions about it. 

        The chatbot can also offer insights from your parsed resume data, if you choose to upload one.    
        </p>

        <p align="justify">
            <b></b> 
            <b></b>
            Want to explore the details of my project or get insights from your parsed resume data (if uploaded)? Ask the AI chatbot below!<br/>
            **Here are some examples of what you can ask:**<br/>
            * "What is Resime Analyzer?"<br/>
            * "Technology Used?"<br/>
            * "About project?" (if relevant)<br/>
            * "Hello?" <br/>
        </p>

        <p align="justify">
            Launch the Chatbot by Clicking the Button  
        </p>
